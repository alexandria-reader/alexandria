...
export default function Languages() {
  ...
  const languages = useAtomValue(languagesState);
        ...
        <div className="shadow-sm sm:rounded-md sm:overflow-hidden">
          <div className="px-4 py-5 bg-tertiary sm:p-6 flex flex-col gap-4">
            ...
            <div>
              ...
              </label>
              {
                <select
                  ...
                  className="input bg-four dark:border-transparent appearance-none rounded-md relative block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-tertiary focus:outline-hidden focus:ring-sky-600 focus:border-sky-600 focus:z-10 sm:text-sm"
                >
                  {languages.map((lang) => (
            ...
            <div className="pt-2 text-right">
              <button
                type="submit"
                className="button-lang-preferences relative inline-flex items-center px-8 py-2 border border-transparent rounded-md shadow-xs text-sm font-medium text-white bg-sky-600 hover:bg-sky-500 focus:outline-hidden focus:ring-2 focus:ring-offset-2 focus:ring-sky-600"
              >
                Save
              </button>
            </div>
